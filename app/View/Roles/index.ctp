<div class="roles index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($role['CreatedBy']['id'], array('controller' => 'users', 'action' => 'view', $role['CreatedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($role['ModifiedBy']['id'], array('controller' => 'users', 'action' => 'view', $role['ModifiedBy']['id'])); ?>
		</td>
		<td class="actions">
